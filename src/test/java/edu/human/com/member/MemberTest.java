...
public class MemberTest {
	...
	public void updateMember() throws Exception {
		...
		memberVO.setORGNZT_ID("ORGNZT_0000000000000");//외래키이기때문
		//암호값에 공백이면 , 쿼리에서 제외
		String secPassword = "";
		...
		memberVO.setGROUP_ID("GROUP_00000000000000");//외래키이기때문
		memberVO.setEMPLYR_STTUS_CODE("P");//회원상태코드
		memberVO.setESNTL_ID("USRCNFRM_00000000000");//고유ID이기때문
	...
	public void insertMember() throws Exception {
		...
		pageVO.setQueryPerPageNum(10000);//JUnit테스트 전용으로 10000정도로 해서 에러안나게 처리
	...
	@Test
	public void selcetMember() throws Exception {
		PageVO pageVO = new PageVO();
		List<EmployerInfoVO> memberList = memberService.selectMember(pageVO);
