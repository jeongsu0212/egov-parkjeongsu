...
public class HomeController {
	...
	@Autowired //자바8버전 나오기전 많이 사용함. 자바8이후 @Inject로 사용, 아주예전 @Resource
	...
	public String view_board(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "board/view_board.tiles";//tiles로 리턴받으면 루트가 tiles폴더가 루트가되고, view_board.jsp내용이 content영역에 나옴
	}
